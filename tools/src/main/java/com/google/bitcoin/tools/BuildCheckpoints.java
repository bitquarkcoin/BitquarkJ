...
public class BuildCheckpoints {
    ...
    public static void main(String[] args) throws Exception {
		...
		peerGroup.addAddress(InetAddress.getByName("173.216.113.20"));
		peerGroup.addAddress(InetAddress.getByName("173.204.118.123"));
		peerGroup.addAddress(InetAddress.getByName("71.235.216.177"));
        long now = new Date().getTime() / 1000;
        peerGroup.setFastCatchupTimeSecs(now);

        final long twoDaysAgo = now - (400 * 1);
